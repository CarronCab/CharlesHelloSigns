        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplicationContext(), "Entrez votre mail", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (password.length() < 6) {
                    Toast.makeText(getApplicationContext(), "MDP trop court, 6 caractères minimum", Toast.LENGTH_SHORT).show();
                    return;
                }
